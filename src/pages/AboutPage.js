        ...
        <Container>
            ...
            <Row className='row-content'>
                <Col sm='6'>
                    <h3>Our Mission</h3>
                    <p>
                        We present a curated database of the best hotels in the
                        ...
                        each hotel to make sure that they are up to our
                        standards. We also present a platform for campers to share
                        reviews on hotels they have visited with each other.
                    </p>
                </Col>
                <Col sm='6'>
                    <Card>
                        ...
                        <CardBody>
                            <dl className='row'>
                                ...
                                <dt className='col-6'>No. of Hotels in 2019</dt>
